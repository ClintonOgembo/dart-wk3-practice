// a singleton refers to a design pattern where a class ensures that only one instance of itself is created and provides a global point of access to that instance.
